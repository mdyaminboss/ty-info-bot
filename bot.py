...
def process_uid(message):
    ...
    # ইউআইডি শুধু সংখ্যা কি না এবং অন্তত ৫-১২ ডিজিটের কি না চেক করা
    ...
    try:
        # সময়সীমা (timeout) ১০ সেকেন্ড রাখা হয়েছে যেন স্লো হলে ধরে ফেলে
        ...
        if response.status_code == 200 and 'AccountInfo' in data and data.get('AccountInfo'):
            ...
            # সুন্দর স্পেস ও গোছানো প্রিমিয়াম লেআউট
            result_text = (
                "┏━━━━━━━━━━━━━━━━━━━━┓\n"
                "┃     💎 TY INFO CHECKER       ┃\n"
                "┗━━━━━━━━━━━━━━━━━━━━┛\n\n"
            ...
            # সার্ভার থেকে ডাটা না পেলে বা ভুল UID হলে সুন্দর মেসেজ
        ...
        bot.edit_message_text(
            "⏳ **Server Timeout!** The server is taking too long to respond. Please try again later.",
            message.chat.id,
            process_msg.message_id
        )
    except Exception:
        # কোনো হাবিজাবি বা টেকনিক্যাল এরর লিংক হাইড করে সুন্দর প্রফেশনাল মেসেজ দেখাবে
        bot.edit_message_text(
